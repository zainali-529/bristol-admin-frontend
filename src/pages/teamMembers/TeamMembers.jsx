...
import { Search, Filter, Plus, MoreHorizontal, Edit, Trash2, Eye, EyeOff, X, Linkedin, Mail, Twitter, Globe } from 'lucide-react'
    ...
    <div className="space-y-6">
      ...
      {stats && (
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          >
            <div>
              <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>Total Members</p>
